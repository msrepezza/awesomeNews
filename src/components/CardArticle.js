...
export const CardArticle = ({ data }) => {
  ...
  return (
    <div className='bg-white m-2 box-content h-124 max-w-124 box-border border-2 border-neutral'>
          ...
          <div className='p-4 divide-y divide-neutral'>
            <div className='flex items-center justify-between h-12'>
              <div className='bodyDescription'> 
                ...
                <span className='bodyDescription'> {data.category} </span>
              </div>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div>
              <div className='flex items-center justify-between h-12' >
                <div>
                  ...
                  <span className='bodyDescription'> { formatDate(data.createdAt) } </span>
                </div>
                <div>
