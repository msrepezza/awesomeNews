...
export const Article = () => {
  ...
  const article = createArray(newsData).find(n => n.id === String(id) );
        ...
        <div className='grid box-content w-600 justify-items-center'>
          <div>
            <div className='grid grid-cols-3 justify-between'>
              <div className='bodyDescription text-center'> { formatDate(article.createdAt) } </div>
              <div className='bodyDescription text-center'> 
                <span>
                  ...
                  </svg></span> <span> {article.views} </span>
              </div>
              <div className='bodyDescription text-center'> {article.category} </div>
            </div>
          </div>
